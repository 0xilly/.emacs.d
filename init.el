...
(tool-bar-mode -1)    ;Dsiable toolbar
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(tide js2-mode go-mode cargo rust-mode nasm-mode evil-vimish-fold vimish-fold treemacs-magit treemacs-icons-dired treemacs-projectile treemacs-evil projectile elcord company-box lsp-ivy lsp-treemacs neotree clangd lsp-ui company-lsp vscode-dark-plus-theme helpful doom-themes counsel ivy-rich which-key rainbow-delimiters rainbow-delemiters doom-modeline ivy command-log-mode use-package)))
(custom-set-faces
